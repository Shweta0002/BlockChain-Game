...
contract MarketPlace{
    ...
    function setErc20Address(address ___address) public onlyOwner{  // set ERC20 address
        stars = erc20(___address);
    }
    
    function contractAddress(address maketPlace) public { // set market place address
    ...
    function setNftPrice(uint256 _price) public onlyOwner{ // this is rresponsible for setting the nft price
        tokenPrice = _price;
    }
